...
export type PostRefreshResponse =
  PostRefreshResponses[keyof PostRefreshResponses];
...
export type PostForgotPasswordError =
  PostForgotPasswordErrors[keyof PostForgotPasswordErrors];
...
export type PostManage2FaResponse =
  PostManage2FaResponses[keyof PostManage2FaResponses];
...
export type GetManageInfoResponse =
  GetManageInfoResponses[keyof GetManageInfoResponses];
...
export type PostManageInfoError =
  PostManageInfoErrors[keyof PostManageInfoErrors];
...
export type PostManageInfoResponse =
  PostManageInfoResponses[keyof PostManageInfoResponses];
...
export type PostOAuthGoogleCallbackData = {
  body: {
    Credential?: string;
  };
  path?: never;
...
export type PostOAuthGoogleCallbackResponses = {
  /**
   * OK
   */
  200: unknown;
